(() => {
	...
	__webpack_require__.c = __webpack_module_cache__; /* webpack/runtime/compat get default export */
	...
	(() => {
		var inProgress = {};
		var dataWebpackPrefix = "host:"; // loadScript function to load a script via script tag
		...
		__webpack_require__.f.remotes = (chunkId, promises) => {
			if (__webpack_require__.o(chunkMapping, chunkId)) {
				chunkMapping[chunkId].forEach(id => {
					...
					//__webpack_require__("webpack/container/reference/remote", 0); //加载remoteEntry.js
				});
			}
		};
